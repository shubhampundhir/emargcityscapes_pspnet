...
resume = False
test_cfg = dict(show_class=False, type='TestLoop')
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='splits/val.txt',
        data_prefix=dict(
            img_path='/content/drive/MyDrive/EMargData/Images',
            seg_map_path='/content/drive/MyDrive/EMargData/GroundLabel'),
        data_root='/content/drive/MyDrive/EMargData',
        pipeline=[
...
work_dir = '/content/mmsegmentation/work_dirs/log_files'
